...
export function ServiceForm({
 ...
 <Text className="font-sans text-sm font-semibold text-on-surface">نوع الخدمة</Text>
 ...
 value === opt.value ? 'border-brand-600 bg-primary-container/10' : 'border-outline-variant bg-white',
 ].join(' ')}
 key={opt.value}
 ...
 value === opt.value ? 'text-primary' : 'text-on-surface'
 }`}
 >
 {opt.label}
 </Text>
