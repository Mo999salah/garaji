      ...
      <View className="gap-2">
        {checklist.map((item, index) => (
          ...
          >
            ...
            <Text className="font-sans text-xs font-bold text-muted dark:text-dark-muted">
      ...
      <View className="mt-4 gap-3">
        {inspection ? (
          <View className="gap-3">
            <Text className="font-sans text-right text-sm leading-6 text-ink dark:text-dark-ink">
            ...
            <View className="gap-2">
              {inspection.checklist.map((item) => (
                ...
                >
                  <Text className="font-sans text-sm font-bold text-ink dark:text-dark-ink">
                    {item.label}
                  </Text>
                  <Text className="font-sans text-xs font-bold text-muted dark:text-dark-muted">
                    {CHECKLIST_LABELS[item.status]}
