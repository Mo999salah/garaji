...
export function RequestInvoiceSection({
 ...
 <Text className="font-sans text-right text-xs text-on-surface-variant">
 {item.quantity.toLocaleString('ar-SA')} × {formatMoney(item.unitPrice)}
 </Text>
 </View>
 <Text className="font-sans text-sm font-black text-on-surface">
 ...
 <View className="flex-row-reverse items-center justify-between border-t border-outline-variant pt-3">
