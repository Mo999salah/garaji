  ...
  return (
    ...
    >
      <View className="flex-1 justify-end bg-black/35 px-4 pb-5">
        ...
        <View className="rounded-lg border border-line bg-white p-5 shadow-tactile-md dark:border-dark-line dark:bg-dark-card">
          <View className="items-end">
            ...
            <Text className="font-sans mt-4 text-right text-2xl font-black text-ink dark:text-dark-ink">
              {title}
            </Text>
