...
export function SkeletonCard({ className = '', variant = 'request' }: SkeletonCardProps) {
 ...
 className={`min-h-[104px] flex-1 rounded-3xl border border-outline-variant/30 bg-surface p-4 shadow-soft ${className}`}
 >
 ...
 accessibilityLabel="جارٍ تحميل المحتوى"
 accessibilityRole="progressbar"
 className={`min-h-[112px] rounded-3xl border border-outline-variant/30 bg-surface p-4 shadow-soft ${className}`}
 >
 <View className="items-end gap-3">
 ...
 accessibilityLabel="جارٍ تحميل المحتوى"
 accessibilityRole="progressbar"
 className={`rounded-3xl border border-outline-variant/30 bg-surface p-6 shadow-soft ${className}`}
 >
