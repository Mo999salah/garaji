    ...
    <View className="flex-1 bg-surface">
      ...
      >
        <Animated.View entering={FadeInUp.delay(100).springify()} className="items-center mt-4">
          ...
          <Text className="font-title-lg text-[24px] font-bold text-on-surface text-center mb-2">
            كيف كانت تجربتك؟
          </Text>
        ...
        <Animated.View entering={FadeInUp.delay(200).springify()} className="mt-2">
          ...
          <View className="bg-surface-container-lowest border border-outline-variant/50 rounded-[20px] p-4 h-32">
            <TextInput
