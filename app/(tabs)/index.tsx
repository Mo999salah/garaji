...
export default function CustomerHomeScreen() {
 ...
 case 'in_progress': return 'bg-[#008378]/20 text-primary'; // primary-container text-primary
 ...
 <Text className="font-label-sm text-label-sm text-[#f4fffc] opacity-90 text-right">احجز في أقرب مركز خدمة</Text>
 </View>
 </View>
 ...
 <Pressable 
 key={request.id}
 className="bg-surface-container-lowest rounded-2xl p-4 shadow-soft active:scale-[0.98]"
