...
import { Alert, View, Pressable, ScrollView, RefreshControl, I18nManager } from 'react-native';
...
export default function CustomerVehiclesScreen() {
 ...
 className="w-full bg-surface-container-lowest rounded-3xl p-4 shadow-soft flex-row-reverse items-center active:scale-[0.99] mb-4"
 >
 {/* Right Icon */}
 ...
 <Pressable 
        ...
        className={`absolute bottom-24 ${I18nManager.isRTL ? 'right-margin-mobile' : 'left-margin-mobile'} w-14 h-14 bg-primary rounded-full shadow-elevated flex items-center justify-center active:scale-90 z-40`}
      >
