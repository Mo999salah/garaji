...
export function ErrorBoundary({ error, retry }: ErrorBoundaryProps) {
 ...
 <View className="w-full max-w-md items-end rounded-lg border border-outline-variant bg-white p-6 shadow-elevated">
 ...
 <Text className="font-sans mt-5 text-right text-2xl font-black text-on-surface">
 عذراً، حدث خطأ غير متوقع
 </Text>
 <Text className="font-sans mt-2 text-right text-sm leading-6 text-on-surface-variant">
 أعد تحميل التطبيق للمتابعة بأمان.
 </Text>
 <Pressable
 accessibilityLabel="إعادة تحميل التطبيق"
 accessibilityRole="button"
 className="mt-6 min-h-12 w-full items-center justify-center rounded-lg bg-warning px-5 active:opacity-85"
 onPress={() => void retry()}
 >
