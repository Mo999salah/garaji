...
function AdminMaintenancePlanCard({
 ...
 <Text className="font-sans text-xs text-on-surface-variant">{vehicleLabel}</Text>
 <Text className="font-sans text-right text-lg font-bold text-on-surface">
 {plan.title}
 </Text>
 <Text className="font-sans text-right text-sm text-on-surface-variant">
 ...
 <Text
 className={`font-sans text-right text-xs font-bold ${plan.isActive ? 'text-success' : 'text-on-surface-variant'}`}
 >
